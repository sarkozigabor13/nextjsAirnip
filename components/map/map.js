...
import { Center, Box, Flex, Text } from "@chakra-ui/layout";
  ...
  return (
    ...
    >
      ...
      <line
        ...
        x2="6"
        y2="58"
        stroke="url(#paint0_linear_1529_26016)"
        strokeWidth="2"
      />
      <path
        d="M6.75593 63.1271C6.35716 63.5876 5.64284 63.5876 5.24407 63.1271L2.23682 59.6547C1.67594 59.007 2.136 58 2.99275 58L9.00725 58C9.864 58 10.3241 59.007 9.76318 59.6547L6.75593 63.1271Z"
        fill="#00BFFF"
      />
      <defs>
        <linearGradient
          id="paint0_linear_1529_26016"
          x1="4.39454"
          y1="6.99999"
          x2="7.97766"
          y2="62.9271"
  ...
  return (
    ...
    >
      ...
      <line
        ...
        x2="6"
        y2="58"
        stroke="url(#paint0_linear_1529_26020)"
        strokeWidth="2"
      />
      <path
        d="M6.75593 63.1271C6.35716 63.5876 5.64284 63.5876 5.24407 63.1271L2.23682 59.6547C1.67594 59.007 2.136 58 2.99275 58L9.00725 58C9.864 58 10.3241 59.007 9.76318 59.6547L6.75593 63.1271Z"
  ...
  return (
    ...
    >
      ...
      <line
        ...
        x2="6"
        y2="94"
        stroke="url(#paint0_linear_1529_26034)"
        strokeWidth="2"
      />
      <path
        d="M6.75593 99.1271C6.35716 99.5876 5.64284 99.5876 5.24407 99.1271L2.23682 95.6547C1.67594 95.007 2.136 94 2.99275 94L9.00725 94C9.864 94 10.3241 95.007 9.76318 95.6547L6.75593 99.1271Z"
        fill="#E270DA"
      />
      <defs>
        <linearGradient
          id="paint0_linear_1529_26034"
          x1="6"
          y1="18.3478"
          x2="6"
          y2="86.4348"
  ...
  return (
    ...
    >
      ...
      <line
        ...
        x2="6"
        y2="58"
        stroke="url(#paint0_linear_1529_26024)"
        strokeWidth="2"
      />
      <path
        d="M6.75593 63.1271C6.35716 63.5876 5.64284 63.5876 5.24407 63.1271L2.23682 59.6547C1.67594 59.007 2.136 58 2.99275 58L9.00725 58C9.864 58 10.3241 59.007 9.76318 59.6547L6.75593 63.1271Z"
  ...
  return (
    ...
    >
      ...
      <line
        ...
        x2="4"
        y2="114"
        stroke="url(#paint0_linear_1529_26111)"
        strokeWidth="2"
      />
      <defs>
        <linearGradient
          id="paint0_linear_1529_26111"
          x1="3"
          y1="35.9624"
          x2="3.00001"
          y2="103.139"
...
const MobileDoubleArrowSecond = () => {
  return (
    ...
    >
      <path
        d="M5.35492 0.851403C5.75307 0.399588 6.45731 0.399589 6.85545 0.851404L9.92863 4.33886C10.4977 4.9847 10.0392 6 9.17836 6L3.03201 6C2.1712 6 1.71263 4.9847 2.28175 4.33886L5.35492 0.851403Z"
        fill="#F4A0A4"
      />
      <path
        d="M6.10516 6C6.10516 20 11.1928 32 28.9996 32"
        stroke="#F4A0A4"
        strokeWidth="2"
        strokeDasharray="4 4"
      />
      <path
        d="M6.10523 6C6.10523 16 -6.61341 64 29 64"
        stroke="#F4A0A4"
        strokeWidth="2"
        strokeDasharray="4 4"
      />
...
const Texts = {
  steps: {
    ...
    two: "Select a brief template",
    three: "Create a quote",
    four: "Plan capacity and timeline for project",
    five: "Monitor project",
    six: "Check agency's health on a single dashboard",
  },
  arrows: {
    one: "Take client brief",
    twoFirst: "Request quote from contractor",
    twoSecond: "Get estimations from teammates",
    threeFirst: "Time spent vs. Estimate",
    threeSecond: "Insights to help you keep project on track",
  },
  bottom: "Better results for future projects based Airnip recommendations",
};
    ...
    >
        ...
        <Center justifyContent="center">
          ...
          <Box {...Styles.BoxStyles}>
            <Flex>
              ...
              <Box {...Styles.RightBoxStyles} border="1px solid #70DBFF">
                <Center>{Texts.steps.two}</Center>
              </Box>
            </Flex>
          </Box>
          <Box {...Styles.ArrowStyles} pb="15px">
            <Center>
              <Text {...Styles.TextStyles}>{Texts.arrows.one}</Text>
            </Center>
            <Center>
              <ArrowSecond />
            </Center>
          ...
          <Box {...Styles.BoxStyles}>
            <Flex>
              ...
              <Box {...Styles.RightBoxStyles} border="1px solid #F8E29B">
                <Center>{Texts.steps.three}</Center>
              </Box>
            </Flex>
          </Box>
          <Box {...Styles.ArrowStyles} pos="relative" right="130px">
            ...
            <Box pos="absolute" minW="206px" top="48px" left="0px">
              <Text {...Styles.TextStyles} mb="12px">
                {Texts.arrows.twoFirst}
              </Text>
              <Text {...Styles.TextStyles}>{Texts.arrows.twoSecond}</Text>
            </Box>
          </Box>
        ...
        <Center justifyContent="center" mt="120px">
          <Box pos="relative" right="-62px" top="-115px">
            ...
            <Box pos="absolute" minW="260px" top="18px" left="4px">
              <chakra.div {...Styles.TextStyles} mb="12px">
                {Texts.arrows.twoFirst}
              </chakra.div>
              <chakra.div {...Styles.TextStyles}>
                {Texts.arrows.twoSecond}
              </chakra.div>
            </Box>
          </Box>
          ...
          <Box {...Styles.BoxStyles}>
            <Flex>
              ...
              <Box {...Styles.RightBoxStyles} border="1px solid #F4A0A4">
                <Center>{Texts.steps.five}</Center>
              </Box>
            </Flex>
          </Box>
          <Box {...Styles.ArrowStyles}>
          ...
          <Box {...Styles.BoxStyles}>
            <Flex>
              ...
              <Box {...Styles.RightBoxStyles} border="1px solid #EFAFEA">
                <Center>{Texts.steps.four}</Center>
              </Box>
            </Flex>
          </Box>
        </Center>
      ...
      <Flex justifyContent="center">
        <Center justifyContent="center" mt="88px">
          <Box {...Styles.BoxStyles} {...Styles.IllustrationBoxStyles}>
            <Flex>
              <Center
                backgroundColor="#d6e5ff"
                border="1px solid #70A4FF"
              ...
              <Box {...Styles.RightBoxStyles} border="1px solid #70A4FF">
                <Center>{Texts.steps.six}</Center>
              </Box>
            </Flex>
            <Box {...Styles.IllustrationStyles}>
      ...
      <Flex justifyContent="center" mt="16px">
        <Center justifyContent="center">
          <Text fontSize="14px">{Texts.bottom}</Text>
        </Center>
      </Flex>
    </Box>
  );
...
const RouteMobile = () => {
  return (
    <Box
      ...
      width={["100%", "80%", "60%"]}
    >
      <Box {...Styles.BoxStyles} {...Styles.MobileBoxStyles}>
        <Flex>
          <Center
            backgroundColor="#d6e5ff"
            border="1px solid #70A4FF"
            {...Styles.LeftBoxStyles}
          >
            <chakra.span {...Styles.CircleStyles} backgroundColor="#005CFF" />
          </Center>
          <Box {...Styles.RightBoxStyles} border="1px solid #70A4FF">
            <Center>{Texts.steps.one}</Center>
          </Box>
      ...
      <Box {...Styles.BoxStyles} {...Styles.MobileBoxStyles}>
        <Flex>
          <Center
            ...
            {...Styles.LeftBoxStyles}
          >
            <chakra.span {...Styles.CircleStyles} backgroundColor="#00BFFF" />
          </Center>
          <Box {...Styles.RightBoxStyles} border="1px solid #70DBFF">
            <Center>{Texts.steps.two}</Center>
          </Box>
      ...
      <Box {...Styles.BoxStyles} {...Styles.MobileBoxStyles}>
        <Flex>
          <Center
            ...
            {...Styles.LeftBoxStyles}
          >
            <chakra.span {...Styles.CircleStyles} backgroundColor="#F2CC4D" />
          </Center>
          <Box {...Styles.RightBoxStyles} border="1px solid #F8E29B">
            <Center>{Texts.steps.three}</Center>
          </Box>
      ...
      <Box {...Styles.MobileArrowStyles}>
        <Flex>
          ...
          <Flex pl="23px">
            ...
            <Box>
              <Text {...Styles.TextStyles} pt="23px" pb="13px">
                {Texts.arrows.twoFirst}
              </Text>
              <Text {...Styles.TextStyles}>{Texts.arrows.twoSecond}</Text>
            </Box>
      ...
      <Box {...Styles.BoxStyles} {...Styles.MobileBoxStyles}>
        <Flex>
          <Center
            ...
            {...Styles.LeftBoxStyles}
          >
            <chakra.span {...Styles.CircleStyles} backgroundColor="#E270DA" />
          </Center>
          <Box {...Styles.RightBoxStyles} border="1px solid #EFAFEA">
            <Center>{Texts.steps.four}</Center>
          </Box>
      ...
      <Box {...Styles.BoxStyles} {...Styles.MobileBoxStyles}>
        <Flex>
          <Center
            ...
            {...Styles.LeftBoxStyles}
          >
            <chakra.span {...Styles.CircleStyles} backgroundColor="#EB565D" />
          </Center>
          <Box {...Styles.RightBoxStyles} border="1px solid #F4A0A4">
            <Center>{Texts.steps.five}</Center>
          </Box>
      ...
      <Box {...Styles.MobileArrowStyles}>
        <Flex>
          ...
          <Flex pl="23px">
            <Box>
              <MobileDoubleArrowSecond />
            </Box>
            <Box>
              <Text {...Styles.TextStyles} pt="23px" pb="13px">
                {Texts.arrows.twoFirst}
              </Text>
              <Text {...Styles.TextStyles}>{Texts.arrows.threeSecond}</Text>
            </Box>
          </Flex>
        </Flex>
      </Box>
      ...
      <Center justifyContent="center">
        <Text fontSize="14px" color="#272F42" textAlign="center" mt="24px">
          {Texts.bottom}
        </Text>
      </Center>
    </Box>
...
export default function mapLinesSection() {
  return (
    <>
      <Center>
        <Heading {...Styles.Heading}>Project 1</Heading>
      </Center>
      <Center>
        <Route />
        <RouteMobile />
